...
try {
if (command == 'play.1') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + `𝙎𝙀 𝙀𝙎𝙏𝘼 𝘿𝙀𝙎𝘾𝘼𝙍𝙂𝘼𝙉𝘿𝙊 𝙎𝙐 𝘼𝙐𝘿𝙄𝙊, 𝙀𝙎𝙋𝙀𝙍𝙀 𝙐𝙉 𝙈𝙊𝙈𝙀𝙉𝙏𝙊 𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍`, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: 'Aldair', body: '𝙵𝙴𝙽𝙸𝚇 - 𝙳𝙰𝚃𝙰 - 𝙱𝙾𝚃', previewType: 0, thumbnail: fantasyImg.getRandom(),  sourceUrl: canalofc}}}) 
try { 
...
if (command == 'play.2') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + `𝙎𝙀 𝙀𝙎𝙏𝘼 𝘿𝙀𝙎𝘾𝘼𝙍𝙂𝘼𝙉𝘿𝙊 𝙎𝙐 𝙑𝙄𝘿𝙀𝙊, 𝙀𝙎𝙋𝙀𝙍𝙀 𝙐𝙉 𝙈𝙊𝙈𝙀𝙉𝙏𝙊 𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍`, m, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: 'Aldair', body: '𝙵𝙴𝙽𝙸𝚇 - 𝙳𝙰𝚃𝙰 - 𝙱𝙾𝚃', previewType: 0, thumbnail: fantasyImg.getRandom(), sourceUrl: canalofc}}}) 
try {
