...
const smsRowner = () => { return `\`\`\`𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝚈𝙾 𝙲𝙾𝙼𝙾 𝙱𝙾𝚃 𝙻𝙾 𝙿𝚄𝙴𝙳𝙾 𝚄𝚂𝙰𝚁\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁!\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙳𝙴𝚂𝙰𝚁𝙾𝙻𝙻𝙰𝙳𝙾𝚁𝙴𝚂 𝚈 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙿𝚄𝙴𝙳𝙴𝙽 𝚄𝚂𝙰𝚁!\`\`\`\`` }//MODERADORES
...
const smsGroup = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾́𝙻𝙾 𝚂𝙴 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁 𝙴𝙽 𝙶𝚁𝚄𝙿𝙾𝚂!\`\`\`` }//PARA GRUPOS
const smsPrivate = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝚂𝙴 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁 𝙰𝙻 𝙿𝚁𝙸𝚅𝙰𝙳𝙾!\`\`\`` }//AL PRIVADO
const smsAdmin = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙴𝚂 𝙿𝙰𝚁𝙰 𝙰𝙳𝙼𝙸𝙽𝚂 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙾 𝚂𝙴𝚁 𝙰𝙳𝙼𝙸𝙽 𝙿𝙰𝚁𝙰 𝚀𝚄𝙴 𝙿𝚄𝙴𝙳𝙰𝚂 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾!\`\`\`` }//BOT CON ADMIN
const smsUnreg = () => { return `\`\`\`¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙰𝚂 𝙴𝚂𝚃𝙰𝚁 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾(𝙰)  INGRESE .reg1 nombre edad 𝙿𝙰𝚁𝙰 ESTAR 𝚁𝙴𝙶𝙸𝚂𝚃𝚁ADO!\`\`\`` }//VERIFICAR
const smsRestrict = () => { return `\`ESTE COMANDO ESTA DESACTIVADO POR MI CREADOR(A)\`` }//RESTRINGIR COMANDO
...
//main.js
const smsWelcome = () => { return `〽️𝙷𝙾𝙻𝙰 @user 𝙱𝙸𝙴𝙽𝚅𝙴𝙽𝙸𝙳𝙾 〽️

♡ 𝐌𝐄𝐆𝐔𝐌𝐈𝐍 - 𝐁𝐎𝐓 ♡
.menu [ para usar y ver los comandos del bot ]

CANAL OFC: https://whatsapp.com/channel/0029VafZvB6J3jv3qCnqNu3x
...
const smsBye = () => { return ` @user ADIÓS NADIE TE EXTRAÑARÁ

 TE SALISTE O TE SACARON DE EL MEJOR GRUPO EN LA FAZ DE LA TIERRA Y LOS MEJORES ADMINISTRADORES

 TE LO PERDES TODO ASÍ QUE  ADIÓS ESTE ES EL MEJOR GRUPO Y LO SEGUIRÁ SIENDO Y ESTA VIGILADO POR EL MEJOR BOT

♡ 𝐌𝐄𝐆𝐔𝐌𝐈𝐍 - 𝐁𝐎𝐓 ♡ `}
const smsSpromote = () => { return '*@user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdemote = () => { return '*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdesc = () => { return '*SE CAMBIO LA DESCRIPSION DEL GRUPO:*\n\n@desc'}
const smsSsubject = () => { return '*SE CAMBIO EL NOMBRE DEL GRUPO:*\n\n@subject'}
const smsSicon = () => { return '*SE CAMBIO LA FOTO DE PERFIL DEL GRUPO*'}
const smsSrevoke = () => { return '*SE RESTAURO EL ENLACE!*\n\n*@revoke*'}
...
//_allantilink.js
const smsTextoYT = () => { return '♡ 𝐌𝐄𝐆𝐔𝐌𝐈𝐍 - 𝐁𝐎𝐓 ♡ '} 
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}ERES ADMIN EN ESTE GRUPO NO PUEDO ELIMINARTE`}
const smsEnlaceWat = () => { return `${lenguajeGB['smsAvisoAG']()}ENVIARON UN ENLACE DE OTRO GRUPO \n\nPROCEDO A ELIMINARLO`}
...
const eGataCoins = () => { return 'MeguCoins' }
...
//_antiviewonce.js
const smsAntiView = () => { return `NO SE PUEDE OCULTAR IMAGENES EN ESTE GRUPO O CHAT`} 
...
const smsAfkM4 = () => { return `*NO ETIQUETES A ESTE(A) USUARIO!! ESTÁ AFK)*\n`} 
...
const smsDemott2 = () => { return '*AHORA ES ADMIN DEL GRUPO*'}
const smsDemott3 = () => { return '*YA NO ES ADMIN DEL GRUPO*'}
...
const smskick2 = () => { return `OK ADMIN EL USUARIO FUE ELIMINADO POR ♡ 𝐌𝐄𝐆𝐔𝐌𝐈𝐍 - 𝐁𝐎𝐓 ♡`}
...
const smsContacto4 = () => { return 'Contacto Oficial de ♡ 𝐌𝐄𝐆𝐔𝐌𝐈𝐍 - 𝐁𝐎𝐓 ♡'}
